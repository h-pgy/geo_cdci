...
def cached_mapa_lote_certidao(id_lote:int, output_file:str) -> str:

    gerador_mapa = LoteLocationMapPNGService(raster=True, convert_to_4326=False, default_width=512, default_height=512)
    return gerador_mapa(id_lote, output_file)